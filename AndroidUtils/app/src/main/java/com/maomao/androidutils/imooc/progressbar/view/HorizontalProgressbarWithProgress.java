...
public class HorizontalProgressbarWithProgress extends ProgressBar {
    ...
    private static final int DEFAULT_HEIGHT_RACH = 2; //dp
    ...
    protected int mReachHeight = dp2px(DEFAULT_HEIGHT_RACH);
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        if (endX > 0 ) {
            ...
            canvas.drawLine(0, 0, endX, 0, mPaint); //一条线
        }
    ...
    private int measureHeight(int heightMeasureSpec) {
        ...
        if (mode == MeasureSpec.EXACTLY) {
            ...
            int textHeight = (int) (mPaint.descent() - mPaint.ascent()); //获取字体大小
            result = getPaddingTop() + getPaddingBottom() + Math.max(Math.max(mReachHeight,
    ...
    private void obtainStyledAttrs(AttributeSet attrs) {
        ...
        mTextSize = (int) ta.getDimension(R.styleable
                .HorizontalProgressbarWithProgress_progress_text_size, mTextSize);

        mTextColor = ta.getColor(R.styleable
                .HorizontalProgressbarWithProgress_progress_text_color, mTextColor);

        mTextOffset = (int) ta.getDimension(R.styleable
                .HorizontalProgressbarWithProgress_progress_text_offset, mTextOffset);

        mUnReachColor = ta.getColor(R.styleable
                .HorizontalProgressbarWithProgress_progress_unreach_color, mUnReachColor);

        mUnReachHeight = (int) ta.getDimension(R.styleable
                .HorizontalProgressbarWithProgress_progress_unreach_height, mUnReachHeight);


        mReachColor = ta.getColor(R.styleable
                .HorizontalProgressbarWithProgress_progress_reach_color, mReachColor);

        mReachHeight = (int) ta.getDimension(R.styleable
                .HorizontalProgressbarWithProgress_progress_reach_height, mReachHeight);
